...
$sql = mysqli_query($con, "SELECT * FROM tb_dosen WHERE id_dosen = '$id_login'") or die(mysqli_error($con));
...
// Tambahkan nilai error_reporting yang sesuai
...
<head>
	...
	<title>Dosen | Aplikasi Absensi Praktikum</title>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-secondary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="rekapAbsen">
								<ul class="nav nav-collapse">
									...
									foreach ($mengajar as $dm) { ?>
										<li>
											<a href="?page=materi&pelajaran=<?= $dm['id_mengajar'] ?> ">
						...
						<!-- 
						<li class="mx-4 mt-2">
							<a href="logout.php" class="btn btn-secondary btn-block"><span class="btn-label"> <i class="fas fa-arrow-alt-circle-left"></i> </span> Logout</a> 
						</li> -->
					</ul>
				</div>
			</div>
