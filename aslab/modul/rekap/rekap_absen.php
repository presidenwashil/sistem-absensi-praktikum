...
<div class="page-inner">
	...
	<div class="row">
		...
		<div class="col-md-12 col-xs-12 mt-3">
			...
			<!-- <a target="_blank"
				href="modul/rekap/rekap_1sks.php?pelajaran=<?= $_GET['pelajaran'] ?>&kelas=<?= $d['id_mkelas'] ?>"
				style="text-decoration: none;" class="text-success">
				<div class="alert alert-success alert-dismissible" role="alert">
					<strong>REKAP SEMESTER (
						<?= strtoupper($d['semester']) ?> - <b>
			...
			<!-- <div class="card">
				<div class="card-body">
					<div class="card-list">
						...
						?>
						<a href="modul/rekap/rekap_bulan.php?pelajaran=<?= $_GET['pelajaran'] ?>&bulan=<?= $bulan; ?>"
							class="btn btn-success btn-block text-left" target="_blank"><i class=" fas fa-file-alt"></i>
							BULAN SEKARANG</a>

						<a href="modul/rekap/rekap_bulan.php?pelajaran=<?= $_GET['pelajaran'] ?>&bulan=<?= $bulan - 1; ?>"
							class="btn btn-warning btn-block text-left" target="_blank"><i class=" fas fa-file-alt"></i>
							BULAN SEBELUMYA</a>
