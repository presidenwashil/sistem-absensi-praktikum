...
<?php
$id_login = @$_SESSION['staff'];
$sql = mysqli_query($con, "SELECT * FROM tb_staff
 WHERE id_staff = '$id_login'") or die(mysqli_error($con));
...
<head>
	...
	<title>Staff | Absensi Praktikum</title>
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="purple">
				...
				<a href="index.php" class="logo">
					<b class="text-white">Staff Lab</b>
				</a>
		...
		<div class="main-panel">
			<div class="content">
				...
				if ($page == 'logabsen') {
					if ($act == '') {
						include 'modul/logabsen/logabsen.php';
					} elseif ($act == 'update') {
