<div class="page-inner">
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <a href="" class="btn btn-secondary btn-sm text-white" data-toggle="modal"
                            data-target="#addLab"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="" class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#edit<?= $l['id_lab'] ?>"><i class="far fa-edit"></i> Edit</a>
                                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ??')"
                                            href="?page=master&act=dellab&id=<?= $k['id_lab'] ?>"><i
                                                class="fas fa-trash"></i> Del</a>

                                        <!-- Modal -->
                                        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
                                            id="edit<?= $l['id_lab'] ?>" class="modal fade" style="display: none;">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="id" type="hidden"
                                                                            value="<?= $l['id_lab'] ?>">
                                                                        <input name="kd_lab" type="text"
                                                                            value="<?= $l['kd_lab'] ?>"
                                                                            class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Nama Lab</label>
                                                                        <input name="nama_lab" type="text"
                                                                            value="<?= $l['nama_lab'] ?>"
                                                                            class="form-control">
                                                                    </div>
                                                        ...
                                                        <?php
                                                        if (isset($_POST['edit'])) {
                                                            $save = mysqli_query($con, "UPDATE tb_laboratorium SET kd_lab ='$_POST[kd_lab]',nama_lab='$_POST[nama_lab]' WHERE id_lab='$_POST[id]' ");
                                                            if ($save) {
                                                                echo "<script>
                                                alert('Data diubah !');
            ...
            <!-- Modal -->
            <div id="addLab" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" class="form-horizontal">
                                <div class="form-group">
                                    <label>Kode Lab</label>
                                    <input name="kode" type="text" placeholder="Kode lab ..." class="form-control">
                                    <div class="form-group">
                                        <label>Nama Lab</label>
