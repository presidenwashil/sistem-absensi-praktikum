                        ...
                        <tbody>
                            ...
                            foreach ($kelas as $k) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="?page=master&act=detailkelas&id=<?= $k['id_mkelas'] ?>&nama_kelas=<?= urlencode($k['nama_kelas']) ?>"
                                            class="btn btn-info btn-sm"><i class="fas fa-info-circle"></i> Detail</a>

                                        <a href="" class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#edit<?= $k['id_mkelas'] ?>"><i class="far fa-edit"></i>
                                            Edit</a>
                                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ??')"
                                            href="?page=master&act=delkelas&id=<?= $k['id_mkelas'] ?>"><i
