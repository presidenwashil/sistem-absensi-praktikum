      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title">
            <a href="" class="btn btn-secondary btn-sm text-white" data-toggle="modal" data-target="#myModal"><i
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="" class="btn btn-info btn-sm" data-toggle="modal"
                        data-target="#edit<?= $k['id_matakuliah'] ?>"><i class="far fa-edit"></i> Edit</a>
                      <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ??')"
                        href="?page=master&act=delmapel&id=<?= $k['id_mapel'] ?>"><i class="fas fa-trash"></i> Del</a>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                  <div class="col-md-10">
                                    <div class="form-group">
                                      ...
                                      <input name="id" type="hidden" value="<?= $k['id_matakuliah'] ?>">
                                      <input name="kode" type="text" value="<?= $k['kode_matakuliah'] ?>"
                                        class="form-control">
                                    </div>
                                    <div class="form-group">
                                      <label>Nama Matakuliah</label>
                                      <input name="matakuliah" type="text" value="<?= $k['matakuliah'] ?>"
                                        class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select name="id_semester" class="form-control">
                                        ...
                                        foreach ($smt as $sm) {
                                          $selected = ($sm['id_semester'] == $s['id_semester']) ? 'selected' : '';
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select name="id_thajaran" class="form-control">
                                        ...
                                        foreach ($tha as $th) {
                                          $selected = ($th['id_thajaran'] == $t['id_thajaran']) ? 'selected' : '';
                              ...
                              <?php
                              if (isset($_POST['edit'])) {
                                $save = mysqli_query($con, "UPDATE tb_matakuliah SET matakuliah='$_POST[matakuliah]' WHERE id_matakuliah='$_POST[id]' ");
                                if ($save) {
                                  echo "<script>
                        alert('Data diubah !');
