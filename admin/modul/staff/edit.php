...
$edit = mysqli_query($con, "SELECT * FROM tb_staff WHERE id_staff='$_GET[id]' ");
foreach ($edit as $d) ?>
				...
				<div class="card-body">
					<form action="?page=staff&act=proses" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input name="nama" type="text" class="form-control" value="<?= $d['nama_staff'] ?>">
						</div>
						...
						<div class="form-group">
							<p>
								<img src="../assets/img/user/<?= $d['foto']; ?>" class="img-fluid rounded-circle kotak"
						...
						<div class="form-group">
							<button name="editStaff" type="submit" class="btn btn-primary"><i class="fa fa-save"></i>
								Update</button>
