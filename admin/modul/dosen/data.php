      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title">
            <a href="?page=dosen&act=add" class="btn btn-secondary btn-sm text-white"><i class="fa fa-plus"></i>
              Tambah</a>
          </div>
        </div>
        <div class="card-body">
              ...
              <tbody>
                ...
                foreach ($dosen as $g) { ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-info btn-sm" href="?page=dosen&act=edit&id=<?= $g['id_dosen'] ?>"><i
                          class="far fa-edit"></i></a>
                      <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ??')"
                        href="?page=dosen&act=del&id=<?= $g['id_dosen'] ?>"><i class="fas fa-trash"></i>
                      </a>
