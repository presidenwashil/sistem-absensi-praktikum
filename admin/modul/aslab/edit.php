...
$edit = mysqli_query($con,"SELECT * FROM tb_aslab WHERE id_aslab='$_GET[id]' ");
foreach ($edit as $d)?>
                ...
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Form Edit Aslab</h3>
                    </div>
                    <div class="card-body">
						<form action="?page=aslab&act=proses" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>NIA</label>
								<input type="hidden" name="id" value="<?=$d['id_aslab'] ?>">
								<input name="nia" type="text" class="form-control" value="<?=$d['nia'] ?>" readonly>								
							</div>

							<div class="form-group">
								<label>Nama Aslab</label>
								<input name="nama" type="text" class="form-control" value="<?=$d['nama_aslab'] ?>">								
							</div>
...
<!-- 
							...
							<div class="form-group">
								<button name="editAslab" type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Update</button>
