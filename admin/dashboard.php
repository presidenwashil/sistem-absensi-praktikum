								...
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=master&act=mapel">
											<span class="sub-item">Praktikum</span>
										</a>
									</li>
									<li>
										<a href="?page=walas">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=jadwal">
											<span class="sub-item"> Daftar Jaga </span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=kepsek&act=add ">
											<span class="sub-item"> Tambah KA Lab </span>
										</a>
									</li>
									<li>
										<a href="?page=kepsek">
											<span class="sub-item"> Daftar KA Lab </span>
										</a>
									</li>
								</ul>
							</div>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Labcom Wicida (<a href="index.php">Raihan Presiden Washil </a> | 2023)
					</div>				
				</div>
			</footer>
		</div>
