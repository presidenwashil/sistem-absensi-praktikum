...
// jumlah dosen
$jumlahAslab = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_aslab WHERE status='Y' "));
...
// Tambahkan query untuk mendapatkan data kelas yang diampu oleh dosen
$mengajar = mysqli_query($con, "SELECT tb_mengajar.*, tb_mkelas.nama_kelas, tb_matakuliah.matakuliah, tb_semester.semester, tb_thajaran.tahun_ajaran FROM tb_dospem
    ...
    INNER JOIN tb_mengajar ON tb_mkelas.id_mkelas=tb_mengajar.id_mkelas
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="purple">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">LABCOM WICIDA</b>
				</a>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-secondary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=master&act=dospem">
											<span class="sub-item">Dosen Pembimbing</span>
										</a>
									</li>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=jadwal">
											<span class="sub-item"> Daftar Jadwal</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=staff&act=add ">
											<span class="sub-item"> Tambah Staff Lab </span>
										</a>
									</li>
									<li>
										<a href="?page=staff">
											<span class="sub-item"> Daftar Staff Lab </span>
										</a>
									</li>
								</ul>
							</div>
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#aslab">
								<i class="fas fa-user-tie"></i>
								<p>Data Aslab</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="aslab">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=aslab&act=add ">
											<span class="sub-item"> Tambah Aslab </span>
										</a>
									</li>
									<li>
										<a href="?page=aslab">
											<span class="sub-item"> Daftar Aslab </span>
										</a>
									</li>
								</ul>
							</div>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="mahasiswa">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=mahasiswa&act=addkelas ">
											<span class="sub-item"> Pilih Kelas </span>
										</a>
									</li>
								</ul>
							</div>
									...
									foreach ($mengajar as $dm) { ?>
										<li>
											<a href="?page=rekap&pelajaran=<?= $dm['id_mengajar'] ?> ">
												<span class="sub-item"><!-- <?= strtoupper($dm['matakuliah']); ?> -->KELAS (
		...
		<div class="main-panel">
			<div class="content">
				...
				if ($page == 'master') {
					...
					} elseif ($act == 'detailkelas') {
						include 'modul/master/kelas/detail_kelas.php';
					} elseif ($act == 'delete_mahasiswa') {
						include 'modul/master/kelas/del_mahasiswa.php';
						// lab
					} elseif ($act == 'lab') {
					...
					elseif ($act == 'ta') {
						...
						include 'modul/master/dospem/data.php';
					} elseif ($act == 'deldospem') {
						include 'modul/master/dospem/del.php';
					}
					//staff
				} elseif ($page == 'staff') {
					if ($act == '') {
					...
					if ($act == '') {
						include 'modul/aslab/data.php';
					} elseif ($act == 'add') {
						include 'modul/aslab/add.php';
					} elseif ($act == 'edit') {
						include 'modul/aslab/edit.php';
					} elseif ($act == 'del') {
						include 'modul/aslab/del.php';
					} elseif ($act == 'proses') {
						include 'modul/aslab/proses.php';
					}
				} elseif ($page == 'dosen') {
					if ($act == '') {
					...
					if ($act == '') {
						...
						include 'modul/mahasiswa/addkelas.php';
					} elseif ($act == 'import_mahasiswa') {
						include 'modul/mahasiswa/import_csv.php';
					} elseif ($act == 'import_kelas') {
						include 'modul/mahasiswa/import_mahasiswa_kelas.php';
					} elseif ($act == 'proses') {
		...
		<footer class="footer">
			<div class="container">
				<div class="copyright ml-auto">
					&copy;
					<?php echo date('Y'); ?> Absensi Labcom Wicida (<a href="index.php">Raihan Presiden Washil </a>
					|
					2023)
				</div>
			</div>
